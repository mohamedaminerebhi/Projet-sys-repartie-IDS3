...
public final class MessagingServiceGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<Message.SendMessageRequest,
      Message.SendMessageResponse> getSendMessageMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "SendMessage",
      requestType = Message.SendMessageRequest.class,
      responseType = Message.SendMessageResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<Message.SendMessageRequest,
      Message.SendMessageResponse> getSendMessageMethod() {
    io.grpc.MethodDescriptor<Message.SendMessageRequest, Message.SendMessageResponse> getSendMessageMethod;
      ...
      synchronized (MessagingServiceGrpc.class) {
        if ((getSendMessageMethod = MessagingServiceGrpc.getSendMessageMethod) == null) {
          MessagingServiceGrpc.getSendMessageMethod = getSendMessageMethod = 
              io.grpc.MethodDescriptor.<Message.SendMessageRequest, Message.SendMessageResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(
                  "MessagingService", "SendMessage"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  Message.SendMessageRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  Message.SendMessageResponse.getDefaultInstance()))
  ...
  private static volatile io.grpc.MethodDescriptor<Message.GetMessagesRequest,
      Message.GetMessagesResponse> getGetMessagesMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "GetMessages",
      requestType = Message.GetMessagesRequest.class,
      responseType = Message.GetMessagesResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<Message.GetMessagesRequest,
      Message.GetMessagesResponse> getGetMessagesMethod() {
    io.grpc.MethodDescriptor<Message.GetMessagesRequest, Message.GetMessagesResponse> getGetMessagesMethod;
      ...
      synchronized (MessagingServiceGrpc.class) {
        if ((getGetMessagesMethod = MessagingServiceGrpc.getGetMessagesMethod) == null) {
          MessagingServiceGrpc.getGetMessagesMethod = getGetMessagesMethod = 
              io.grpc.MethodDescriptor.<Message.GetMessagesRequest, Message.GetMessagesResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(
                  "MessagingService", "GetMessages"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  Message.GetMessagesRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  Message.GetMessagesResponse.getDefaultInstance()))
  ...
  public static abstract class MessagingServiceImplBase implements io.grpc.BindableService {
    ...
    public void sendMessage(Message.SendMessageRequest request,
        io.grpc.stub.StreamObserver<Message.SendMessageResponse> responseObserver) {
    ...
    public void getMessages(Message.GetMessagesRequest request,
        io.grpc.stub.StreamObserver<Message.GetMessagesResponse> responseObserver) {
  ...
  public static final class MessagingServiceBlockingStub extends io.grpc.stub.AbstractStub<MessagingServiceBlockingStub> {
    ...
    /**
     */
    public Message.SendMessageResponse sendMessage(Message.SendMessageRequest request) {
    ...
    /**
     */
    public Message.GetMessagesResponse getMessages(Message.GetMessagesRequest request) {
      return blockingUnaryCall(
  ...
  public static final class MessagingServiceFutureStub extends io.grpc.stub.AbstractStub<MessagingServiceFutureStub> {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<Message.SendMessageResponse> sendMessage(
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<Message.GetMessagesResponse> getMessages(
        Message.GetMessagesRequest request) {
      return futureUnaryCall(
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_SEND_MESSAGE:
          serviceImpl.sendMessage((Message.SendMessageRequest) request,
              (io.grpc.stub.StreamObserver<Message.SendMessageResponse>) responseObserver);
          break;
        case METHODID_GET_MESSAGES:
          serviceImpl.getMessages((Message.GetMessagesRequest) request,
              (io.grpc.stub.StreamObserver<Message.GetMessagesResponse>) responseObserver);
          break;
        default:
